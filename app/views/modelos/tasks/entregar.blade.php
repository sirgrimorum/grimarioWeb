...
<div class='container'>
    ...
    <div class="form-group ">
        <div class='row-sm-height'>
            <div class="col-xs-12 col-sm-4 col-sm-height">
                {{ Form::label('dcuantity', Lang::get('task.labels.dcuantity'), array('class'=>'')) }}
                <span class="help-block" id="work_end_help">
                    {{ Lang::get('task.descriptions.dcuantity') }}
                </span>
                {{ Form::number("dcuantity", "0", array('class' => 'form-control', 'id' => 'dcuantity' )) }}
            </div>
            ...
            <div class="col-xs-12 col-sm-8 col-sm-height">
                ...
                <table class="table table-striped table-bordered" id='list_users'>
                    <thead>
                        <tr>
                            <td>{{ Lang::get('task.labels.users_name') }}</td>
    ...
    <div class="form-group">
        <div class="boton_centrado">
            {{ Form::submit(Lang::get('task.labels.evaluar'), array('class' => 'btn btn-primary', 'name' => 'formaction')) }}
        </div>
    </div>
</div>
{{ Form::close() }}
