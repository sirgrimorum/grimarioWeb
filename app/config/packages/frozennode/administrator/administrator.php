...
return array(
     ...
     * @type string
     */
    'uri' => Lang::get("principal.menu.links.admin"),
    /**
     * Page title
     *
     * @type string
     */
    'title' => Lang::get("principal.menu.admin"),
    /**
    ...
    'menu' => array(
        'articles',
        Lang::get("enterprise.labels.empresa") => array('enterprises', 'teams', 'machines', 'resources', 'tasktypes', 'commenttypes'),
        Lang::get("game.labels.juegos") => array('prices', 'games', 'proyects'),
        Lang::get("task.labels.tareas") => array('payments','tasks', 'comments'),
        'users',
    ),
    /**
...
if (Sentry::check()) {
     ...
     * @type string
     */
    'login_path' => Lang::get("principal.menu.links.usuario") . '/login',
    /**
